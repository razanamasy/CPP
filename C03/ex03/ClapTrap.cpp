...
{
	std::cout << "Clap : String constructor called for " << this->_name << std::endl;
	return ;
}
...
{
	*this = src;
	std::cout << "Clap : Copy constructor called for " << this->_name<<  std::endl;
	return ;
}

ClapTrap::~ClapTrap(void)
{
	std::cout <<  this->_name << " Clap : has been destructed" << std::endl;
	return ;
}
...
void ClapTrap::attack(const std::string& target)
{
	...
	{
		std::cout << "Clap : Not enough energy or point to attack " << std::endl;
		return ;
	}
